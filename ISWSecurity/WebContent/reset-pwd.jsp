                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Recuperando Contraseña</h1>
                                        <p class="mb-4">Ingrese y confirme su contraseña siguiendo las recomendaciones.</p>
                                    </div>
                                    <form class="user" method="post" action="./Sl_RecuperarPwd">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user"
                                                id="newPwd1" name="newPwd1" aria-describedby="emailHelp"
